    ...
    <main>
        <div class="main">
            ...
            <form method="post" action="form.php" style="display: flex; flex-direction: column; gap: 15px; background-color: #202020; padding: 30px; border-radius: 20px; max-width: 500px; margin: 40px auto;">
                ...
                <input type="text" id="name" name="name" required style="padding: 10px; border-radius: 8px; border: none; font-size: 16px;">
                <label for="email">E-mail:</label>
                <input type="email" id="email" name="email" required style="padding: 10px; border-radius: 8px; border: none; font-size: 16px;">
                <label for="message">Wiadomość:</label>
                <textarea id="message" name="message" rows="5" required style="padding: 10px; border-radius: 8px; border: none; font-size: 16px;"></textarea>
